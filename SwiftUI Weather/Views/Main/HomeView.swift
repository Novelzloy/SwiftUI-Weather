...
enum BottomSheetPosition: CGFloat, CaseIterable {
    case top = 0.831 // 702 divide by 844
    case middle = 0.385 // 325 divide by 844
}

struct HomeView: View {
    
    //MARK: - State of Bottom Sheet Position
    ...
    var body: some View {
        NavigationView {
            GeometryReader { geometry in
                ...
                let offsetValue = -bottomSheetTranslationProrated * imageOffset
